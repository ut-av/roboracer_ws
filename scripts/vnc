...
echo "dbus-launch --exit-with-session startxfce4" >> $HOME/.vnc/xstartup.turbovnc
...
/opt/TurboVNC/bin/vncserver :9 -geometry $RESOLUTION -depth 24 -securitytypes VNC -xstartup $HOME/.vnc/xstartup.turbovnc
